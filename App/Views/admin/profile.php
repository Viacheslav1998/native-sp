<div class="custom-silver my-4 p-4 custom-height">
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      в хедере добавить проверку [или] и для пользователя и для админа что видеть навигацию <br> 
      и в футере для отображения перейти на сайт - только для зарегистрированных
      <br>
      страница о нас 
